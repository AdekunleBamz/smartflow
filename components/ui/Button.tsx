...
export function Button({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-accent to-purple-600 text-white hover:opacity-90 focus:ring-accent',
    secondary: 'glass border border-white/10 text-white hover:bg-white/10 focus:ring-white/30',
    ghost: 'text-gray-400 hover:text-accent hover:bg-accent/10 focus:ring-accent/30',
